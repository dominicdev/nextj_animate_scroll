    ...
    return (
        <section className="w-full">
            <div className="flex flex-row justify-center bg-[#282727] m-auto sm:h-full md:h-full lg:h-[60vh]">
                <div className="w-[70%] leading-6 flex sm:mt-20 md:mt-20 sm:flex-col md:flex-col lg:flex-row justify-center items-center font-normal font-sans"> 
                    <div className="flex items-center lg:w-1/2  md:w-[80%] sm:w-[80%] ">
